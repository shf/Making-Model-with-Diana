import math
newProject( "Model the structure/My Model/Master", 10 )
...
generateMesh( [] )
#end
exportModel( "C:/Users/ShayanFa/Documents/Model the structure/My Model/Allfiles/TheOriginal.dat", 5 )
closeProject(  )